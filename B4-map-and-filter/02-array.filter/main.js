...
// const newArray = array.filter((n) => n % 2 == 1);
// console.log(newArray);
...
// const newArray = array.filter((item) => item.length > 6);
// console.log(newArray);
...
// const newArray = array.filter((item) => item.toUpperCase() === item);
// console.log(newArray);
...
const newArray = array.filter((obj) => obj.birth.split('-')[1] === '06');
console.log(newArray);
